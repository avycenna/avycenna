/* https://www.eldoraui.site/docs/components/terminal */
...
const Terminal = ({
  ...
  return (
    ...
    >
      ...
      {/* <pre className="font-mono bg-card w-full min-w-[320px] h-full overflow-hidden rounded-xl border text-[11px] shadow-lg sm:min-w-[480px] sm:text-[12px] md:min-w-[600px] md:text-[13px]"> */}
      <pre className="font-mono w-full min-w-[320px] h-full overflow-hidden rounded-xl border text-[11px] shadow-lg sm:text-[12px] md:text-[13px]">
        <div className="bg-muted flex flex-row items-center gap-2 border-b px-3 py-2 sm:px-4">
          <MacControls />
        </div>
        {/* <div className="from-background to-muted min-h-37.5 bg-linear-to-b h-full"> */}
        <div className="min-h-37.5 h-full">
